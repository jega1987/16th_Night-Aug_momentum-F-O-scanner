[README.md](https://github.com/user-attachments/files/31077302/README.md)
# 14Tth-Aug_momentum-F-O-scanner
14Tth Aug_momentum F&amp;O scanner Kimi based but code created by Claude AI
...
New Project → Deploy from GitHub repo → pick the repo. Nixpacks reads
`.python-version` and `requirements.txt`; `railway.json` sets the start command
and points the health check at `/health`.
