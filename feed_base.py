"""
Feed interface. The scanner only ever talks to this contract, so swapping Kite
for Dhan, Fyers or anything else means writing one new class, not editing the
strategy.
"""
import asyncio
import time
