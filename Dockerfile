...
# setuptools is required explicitly: py5paisa pulls in pbkdf2, which ships as
# an sdist rather than a wheel. It is pure Python, so no compiler is needed.
...
sqlalchemy, psycopg2, pytz, httpx, pyotp, dotenv, py5paisa, websocket; \
